...
chinese_given_name_map = {
    ...
    '凤': 'ホウ', '凰': 'オウ', '鸳': 'エン', '鸯': 'オウ',
    '耀': 'ヨウ', 
    '旭': 'キョク', '翔': 'ショウ', '健': 'ケン', '康': 'コウ',
    '福': 'フク', '寿': 'ジュ', '喜': 'キ', '乐': 'ラク',
    '安': 'アン', '宁': 'ネイ', '顺': 'ジュン', '利': 'リ',
    '发': 'ハツ', '财': 'ザイ', '宝': 'ホウ', '玉': 'ギョク',
    '珠': 'シュ', '珍': 'チン', '瑞': 'ズイ', '祥': 'ショウ',
    '吉': 'キチ', '庆': 'ケイ', '贺': 'ガ', '荣': 'エイ',
    '华': 'カ', '富': 'フ', '贵': 'キ', '昌': 'ショウ',
    '盛': 'セイ', '旺': 'オウ', '兴': 'コウ', '隆': 'リュウ',
    '达': 'タツ', '通': 'ツウ', '和': 'ワ', '平': 'ヘイ',
    '泰': 'タイ', '安': 'アン', '宁': 'ネイ', '静': 'セイ',
    '雅': 'ガ', '文': 'ブン', '武': 'ブ', '德': 'トク',
    '义': 'ギ', '仁': 'ジン', '礼': 'レイ', '智': 'チ',
    '信': 'シン', '忠': 'チュウ', '孝': 'コウ', '节': 'セツ',
    '勇': 'ユウ', '猛': 'モウ', '威': 'イ', '严': 'ゲン',
    '正': 'セイ', '直': 'チョク', '方': 'ホウ', '圆': 'エン',
    '美': 'ビ', '丽': 'レイ', '艳': 'エン', '娇': 'キョウ',
    '媚': 'ビ', '妍': 'ゲン', '姝': 'シュ', '娟': 'ケン',
    '娥': 'ガ', '娴': 'カン', '淑': 'シュク', '贤': 'ケン',
    '惠': 'ケイ', '敏': 'ビン', '捷': 'ショウ', '聪': 'ソウ',
    '明': 'メイ', '亮': 'リョウ', '朗': 'ロウ', '清': 'セイ',
    '新': 'シン', '鲜': 'セン', '奇': 'キ', '特': 'トク',
    '异': 'イ', '常': 'ジョウ', '非': 'ヒ', '凡': 'ボン',
    '超': 'チョウ', '越': 'エツ', '卓': 'タク', '绝': 'ゼツ',
    '妙': 'ミョウ', '玄': 'ゲン', '奥': 'オウ', '深': 'シン',
    '远': 'エン', '高': 'コウ', '大': 'ダイ', '广': 'コウ',
    '宏': 'コウ', '伟': 'イ', '壮': 'ソウ', '强': 'キョウ',
    '健': 'ケン', '康': 'コウ', '寿': 'ジュ', '福': 'フク',
    '禄': 'ロク', '禧': 'キ', '祥': 'ショウ', '瑞': 'ズイ',
    ...
    # Additional common two-character given names
    '旭东': 'キョクトウ', '翔宇': 'ショウウ', '健一': 'ケンイチ',
    '康平': 'コウヘイ', '福贵': 'フッキ', '寿康': 'ジュコウ',
    '喜乐': 'キラク', '安乐': 'アンラク', '安宁': 'アンネイ',
    '顺利': 'ジュンリ', '利发': 'リハツ', '发财': 'ハッサイ',
    '宝玉': 'ホウギョク', '玉珠': 'ギョクシュ', '珍珠': 'チンシュ',
    '瑞祥': 'ズイショウ', '吉祥': 'キチショウ', '庆贺': 'ケイガ',
    '荣华': 'エイカ', '富贵': 'フッキ', '昌盛': 'ショウセイ',
    '兴旺': 'コウオウ', '隆达': 'リュウタツ', '通达': 'ツウタツ',
    '和平': 'ワヘイ', '泰安': 'タイアン', '宁静': 'ネイセイ',
    '雅文': 'ガブン', '文武': 'ブンブ', '德义': 'トクギ',
    '仁义': 'ジンギ', '礼智': 'レイチ', '信义': 'シンギ',
    '忠孝': 'チュウコウ', '节勇': 'セツユウ', '威猛': 'イモウ',
    '严正': 'ゲンセイ', '正直': 'セイチョク', '方圆': 'ホウエン',
    '美丽': 'ビレイ', '艳丽': 'エンレイ', '娇媚': 'キョウビ',
    '妍姝': 'ゲンシュ', '娟娥': 'ケンガ', '娴淑': 'カンシュク',
    '贤惠': 'ケンケイ', '敏捷': 'ビンショウ', '聪明': 'ソウメイ',
    '明亮': 'メイリョウ', '清朗': 'セイロウ', '新鲜': 'シンセン',
    '奇特': 'キトク', '异常': 'イジョウ', '非凡': 'ヒボン',
    '超越': 'チョウエツ', '卓越': 'タクエツ', '绝妙': 'ゼツミョウ',
    '玄奥': 'ゲンオウ', '深远': 'シンエン', '高大': 'コウダイ',
    '宏伟': 'コウイ', '伟壮': 'イソウ', '强健': 'キョウケン',
    '康寿': 'コウジュ', '福禄': 'フクロク', '禧祥': 'キショウ',
    '庆荣': 'ケイエイ', '华富': 'カフ', '贵昌': 'キショウ',
    '盛旺': 'セイオウ', '隆兴': 'リュウコウ', '达和': 'タツワ',
    '通平': 'ツウヘイ', '泰宁': 'タイネイ', '安静': 'アンセイ',
    '雅武': 'ガブ', '德仁': 'トクジン', '礼信': 'レイシン',
    '忠勇': 'チュウユウ', '威严': 'イゲン', '正美': 'セイビ',
    '直丽': 'チョクレイ', '方艳': 'ホウエン', '圆娇': 'エンキョウ',
    '美妍': 'ビゲン', '丽娟': 'レイケン', '艳娥': 'エンガ',
    '娇娴': 'キョウカン', '媚淑': 'ビシュク', '妍贤': 'ゲンケン',
    '姝惠': 'シュケイ', '娟敏': 'ケンビン', '娥捷': 'ガショウ',
    '娴聪': 'カンソウ', '淑明': 'シュクメイ', '贤亮': 'ケンリョウ',
    '惠朗': 'ケイロウ', '敏清': 'ビンセイ', '捷新': 'ショウシン',
    '聪鲜': 'ソウセン', '明奇': 'メイキ', '亮特': 'リョウトク',
    '朗异': 'ロウイ', '清常': 'セイジョウ', '新非': 'シンヒ',
    '鲜凡': 'センボン', '奇超': 'キチョウ', '特越': 'トクエツ',
    '异卓': 'イタク', '常绝': 'ジョウゼツ', '非妙': 'ヒミョウ',
    '凡玄': 'ボンゲン', '超奥': 'チョウオウ', '越深': 'エツシン',
    '卓远': 'タクエン', '绝高': 'ゼツコウ', '妙大': 'ミョウダイ',
    '玄广': 'ゲンコウ', '奥宏': 'オウコウ', '深远': 'シンエン',
    '高伟': 'コウイ', '大壮': 'ダイソウ', '广强': 'コウキョウ',
    
    # Modern and popular names
    '子轩': 'シケン', '梓轩': 'シケン', '浩然': 'コウゼン',
    '博文': 'ハクブン', '宇轩': 'ウケン', '子涵': 'シカン',
    '梓涵': 'シカン', '雨泽': 'ウタク', '一诺': 'イチダク',
    '欣怡': 'キンイ', '梓萱': 'シケン', '诗涵': 'シカン',
    '可馨': 'カケイ', '梦琪': 'ムキ', '语嫣': 'ゴエン',
    '雨婷': 'ウテイ', '静怡': 'セイイ', '心怡': 'シンイ',
    '欣妍': 'キンゲン', '雅婷': 'ガテイ', '佳琪': 'カキ',
    '慧怡': 'ケイイ', '思琪': 'シキ', '梦瑶': 'ムヨウ',
    '雪怡': 'セツイ', '雨欣': 'ウキン', '梓晴': 'シセイ',
    '雨萱': 'ウケン', '思涵': 'シカン', '可欣': 'カキン',
    '诗琪': 'シキ', '梦洁': 'ムケツ', '雨薇': 'ウビ',
    '雅静': 'ガセイ', '佳怡': 'カイ', '思颖': 'シエイ',
    '慧琳': 'ケイリン', '欣悦': 'キンエツ', '诗雨': 'シウ',
    '嘉怡': 'カイ', '梦婷': 'ムテイ', '雨涵': 'ウカン',
    '思雨': 'シウ', '雅雯': 'ガブン', '佳雯': 'カブン',
    '慧敏': 'ケイビン', '欣颖': 'キンエイ', '诗雅': 'シガ',
    '嘉琪': 'カキ', '梦菲': 'ムヒ', '雨嘉': 'ウカ',
    '思婷': 'シテイ', '雅琪': 'ガキ', '佳琪': 'カキ',
    '慧婷': 'ケイテイ', '欣婷': 'キンテイ', '诗婷': 'シテイ',
    '嘉怡': 'カイ', '梦瑶': 'ムヨウ', '雨婷': 'ウテイ',
    '思瑶': 'シヨウ', '雅瑶': 'ガヨウ', '佳瑶': 'カヨウ',
    '慧瑶': 'ケイヨウ', '欣瑶': 'キンヨウ', '诗瑶': 'シヨウ',
...
chinese_pinyin_map = {
    ...
    # Additional pinyin mappings for better coverage
    'beng': 'ホウ', 'ceng': 'ソウ', 'chuai': 'サイ', 'cuan': 'サン',
    'cui': 'サイ', 'cun': 'ソン', 'cuo': 'サ', 'deng': 'トウ',
    'diu': 'チュウ', 'dui': 'タイ', 'dun': 'トン', 'fo': 'フ',
    'fou': 'フウ', 'geng': 'コウ', 'guai': 'カイ', 'gun': 'コン',
    'guo': 'カ', 'heng': 'コウ', 'huai': 'カイ', 'hun': 'コン',
    'huo': 'カ', 'jiong': 'キョウ', 'jiu': 'キュウ', 'juan': 'ケン',
    'jun': 'キン', 'keng': 'コウ', 'kuai': 'カイ', 'kun': 'コン',
    'kuo': 'カ', 'leng': 'ロウ', 'liu': 'リュウ', 'luan': 'ラン',
    'lun': 'ロン', 'luo': 'ラ', 'meng': 'モウ', 'miu': 'ミュウ',
    'neng': 'ノウ', 'niang': 'ニョウ', 'niu': 'ニュウ', 'nong': 'ノウ',
    'nuan': 'ナン', 'nuo': 'ナ', 'peng': 'ホウ', 'qiong': 'キョウ',
    'qiu': 'キュウ', 'quan': 'ケン', 'qun': 'キン', 'reng': 'ジョウ',
    'ruan': 'ゼン', 'rui': 'ゼイ', 'run': 'ジュン', 'ruo': 'ジャク',
    'seng': 'ソウ', 'shuai': 'サイ', 'shuan': 'セン', 'shui': 'スイ',
    'shun': 'シュン', 'shuo': 'サク', 'sou': 'ソウ', 'suan': 'サン',
    'sui': 'スイ', 'sun': 'ソン', 'suo': 'サ', 'teng': 'トウ',
    'tui': 'タイ', 'tun': 'トン', 'weng': 'オウ', 'xiong': 'キョウ',
    'xiu': 'シュウ', 'xuan': 'セン', 'xun': 'ジュン', 'yang': 'ヨウ',
    'yao': 'ヨウ', 'yin': 'イン', 'ying': 'エイ', 'yong': 'ヨウ',
    'you': 'ユウ', 'yu': 'ユ', 'yuan': 'エン', 'yue': 'エツ',
    'yun': 'ウン', 'zeng': 'ソウ', 'zhei': 'セイ', 'zhen': 'シン',
    'zheng': 'ショウ', 'zhi': 'シ', 'zhong': 'チュウ', 'zhou': 'シュウ',
    'zhu': 'シュ', 'zhua': 'サ', 'zhuai': 'サイ', 'zhuan': 'セン',
    'zhuang': 'ソウ', 'zhui': 'スイ', 'zhun': 'ジュン', 'zhuo': 'サク',
    'zi': 'シ', 'zong': 'ソウ', 'zou': 'ソウ', 'zu': 'ソ',
    'zuan': 'サン', 'zui': 'サイ', 'zun': 'ソン', 'zuo': 'サ',
}
